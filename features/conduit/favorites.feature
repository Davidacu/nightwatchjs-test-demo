Feature: Favorites
    ...
    @conduit
    Scenario: When James favorites an article it appears at his profile
    ...
    @conduit
    Scenario: When James un-favorites an article it disappears from his profile
    ...
    @conduit
    Scenario: Favorites count increases to 5
        Given James has already registered to Conduit app
        And James has already logged in to conduit
    ...
    @conduit
    Scenario: Favorites count decreases to 3
